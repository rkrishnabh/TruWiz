({
    loadQuestions : function(component, event, helper, reload){
        ...
        if(wizardDisplayLayoutType === 'Table'){
            ...
            //this.initializeQuestionsDatatable(component,event,questionsListInkeyValFormat);
 ...
 */
     ...
     * Comments : This method sets the attributes required for Questions Datatable and initializes it.
     */    
    initializeEditableQuestionsDatatable :function(component,event,questionsListForDisplay){
        console.log('initializeQuestionsDatatable');
        console.log(questionsListForDisplay);
        debugger;
                ...
                if(questionObj.Field_API_Name__c != "Id"){
                    ...
                    if(!questionObj.Has_Condition__c){
                        ...
                        if(questionValue == null || questionValue == undefined || questionValue == '')
                            ...
                            dataExist = true;                        
                        //Commented for inline Edit
                        //questionRow[questionLabel.replace(/ /g,"_")] = questionValue;
                        
                        //Added for inline Edit
                        questionRow["Id"] = questionObj.Id;
                        questionRow["Question_Label__c"] = questionLabel;
                        questionRow["Answer__c"] = questionValue;
                        questionRow["Field_Type__c"] = questionObj.Field_Type__c;
                        questionRow["Help_Text__c"] = questionObj.Help_Text__c;                        
                        questionRow["Has_Condition__c"] = questionObj.Has_Condition__c;
                        questionRow["IsMandatory__c"] = questionObj.IsMandatory__c;
                        questionRow["Lower_Value_Limit__c"] = questionObj.Lower_Value_Limit__c;
                        questionRow["Higher_Value_Limit__c"] = questionObj.Higher_Value_Limit__c;
                        questionRow["Read_Only__c"] = questionObj.Read_Only__c;
                        questionRow["Size__c"] = questionObj.Size__c;
                        questionRow["Input_Pattern__c"] = questionObj.Input_Pattern__c;
                        questionRow["Read_Only__c"] = false;
                        questionRow["Values__c"] = questionObj.Values__c;
                    }
                }
            });
            //For generating Sequence No
